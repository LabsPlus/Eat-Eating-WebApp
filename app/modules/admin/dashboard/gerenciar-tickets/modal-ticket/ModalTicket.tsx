...
const ModalTicket = ({ typeModal, closePurchaseModal, closeEditModal }: IModalTicketProps) => {
  ...
  const { getAllUsers, selectedUser, purchaseTicket, editTicket, setSelectedUser, getInfoTickets } = useStore();
  ...
  const handlePurchaseTicket = async () => {
    try {
      ...
      if (typeModalIsPurchase) {
        errorToast("Não foi possível adicionar o ticket. Verifique e tente novamente.");
      } else {
        errorToast("Não foi possível alterar o ticket. Verifique e tente novamente.");
      }
